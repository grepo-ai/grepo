...
Make the best use of the tools available at your disposal namely list_files tool, read_file tool, grep tool, edit_file tool, glob tool and get_code_block tool each tool is specialised for a single type of task.
