...
grepo_md_theme = Theme(
    {
        ...
        "markdown.h5": f"bold {color_palette['yellow']}",
        "markdown.h6": f"bold {color_palette['green']}",
        # Inline emphasis
        "markdown.em": f"italic {color_palette['yellow']}",
        "markdown.strong": f"bold {color_palette['orange']}",
        "markdown.code_inline": f"black on {color_palette['light-purple']}",
        # Links
        "markdown.link": color_palette["light-purple"],
        "markdown.link_url": color_palette["light-purple"],
        # Lists
        "markdown.item.bullet": color_palette["green"],
        "markdown.item.number": color_palette["yellow"],
        # Block elements
        "markdown.block_quote": f"italic {color_palette['golden']}",
